...
<head>
    ...
    <script src="/ResgistroPQR/js/funciones.js"></script>
            ...
            <div class="col-sm-10">
                <form action="/RegistroPQR/App/usuarios/usuario_editado.php" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" max="9999999999" name="usuario_telefono" id="telefono" class="form-control" required value=<?php echo "'".$usuario_telefono."'"; ?> onkeyup="validarPass()">
                    </div>
                    <?php echo $select; ?>
                    <hr>
